      ...
      <div className="flex flex-col md:flex-row justify-between items-center border-b border-gray-700 pb-8 mb-8">
        ...
        <div className="text-center md:text-left mb-6 md:mb-0">
          ...
          <p className="text-gray-400 mt-4">
            2 Alwin Street Brooklyn, Capetown
          </p>
          <p className="text-gray-400">+27 69 931 0313</p>
          <p className="text-gray-400">info@hostitservices.com</p>
        </div>
        ...
        <div className="text-center md:text-left">
          ...
          <div className="flex justify-center md:justify-start space-x-6">
            <a href="https://www.facebook.com/profile.php?id=61556558713611" className="text-gray-400 hover:text-blue-500 transition duration-300">
              {/* Facebook Icon */}
              <svg
            ...
            <a href="https://www.instagram.com/host_it_services/profilecard/?igsh=Mm9udzQzMHRqaW93" className="text-gray-400 hover:text-pink-500 transition duration-300">
              {/* Instagram Icon */}
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="w-6 h-6"
            ...
            <a href="https://www.linkedin.com/company/host-it-services/" className="text-gray-400 hover:text-blue-700 transition duration-300">
              {/* LinkedIn Icon */}
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="w-6 h-6"
